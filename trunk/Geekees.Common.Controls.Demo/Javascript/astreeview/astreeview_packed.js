...
thisObj=_rdc.a3.findRealTarget(thisObj);if(document.all)e=event;dragDrop_x=this.c7(e)+5;dragDrop_y=this.c8(e)+5;this.b18.style.left=dragDrop_x+'px';this.b18.style.top=dragDrop_y+'px';if(thisObj.tagName=='A'||thisObj.tagName=='IMG')thisObj=thisObj.parentNode;if(thisObj.getAttribute("enable-children")&&thisObj.getAttribute("enable-children").toLowerCase()=="false")
{if(_rdc.a3.a4)
